...
const translations: Record<string, Record<Lang, string>> = {
  ...
  logTripManual: { en: 'Record a trip manually', fr: 'Enregistrer manuellement une course' },
  noZonesCity: { en: 'No zones for this city', fr: 'Pas de zones pour cette ville' },
  generationInProgress: { en: 'Generation in progress…', fr: 'Génération en cours…' },
  ...
  locationOrQueryMissing: { en: 'Location or query missing', fr: 'Localisation ou requête manquante' },
  ...
  noTripZone: { en: 'Zone, date and amount required', fr: 'Zone, date et montant requis' },
  planAsDelivery: { en: 'Plan as delivery route', fr: 'Planifier comme livraison' },
  maxDeliveryScore: { en: 'Max delivery score', fr: 'Score livraison max' },
  bestDeliveryTip: { en: 'Best delivery availability', fr: 'Meilleure disponibilité livraison' },
  suggestDeliveryHotspots: { en: 'Suggest delivery hotspots', fr: 'Suggestion de zones livraison' },
  aiRecommendations: { en: 'AI recommendations', fr: 'Recommandations IA' },
  simulationMode: { en: 'AI simulation mode', fr: 'Mode simulation IA' },
  simulationExplanation: { en: 'Base scores by zone type + hourly multipliers', fr: 'Scores de base par type de zone + multiplicateurs horaires' },
  ...
  openFoodFactsDescription: { en: 'Search food products for delivery locations and density', fr: 'Recherche de produits alimentaires pour livraisons' },
  foursquareDescription: { en: 'Search nearby consumer venues using place API', fr: 'Recherche des lieux proches via API' },
